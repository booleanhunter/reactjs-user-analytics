import { default as UserInteractionResource, UserInteraction } from './resources/userInteractionResource';
...
export { UserInteraction, withDataContext, DataContext, workerInstance, initializeBeacon, type UserInteractionResource, type TrackerProps };
